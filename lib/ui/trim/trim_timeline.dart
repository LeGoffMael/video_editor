...
class TrimTimeline extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        valueListenable: controller.maxDuration,
        builder: (BuildContext context, Duration maxDuration, _) {
          final Duration duration =
              controller.maxDuration.value < controller.videoDuration
          ...
          return Container(
              ...
              child: Row(
                  ...
                  children: [
                    for (int i = 0;
                        i <=
                            (controller.videoDuration.inSeconds / timeGap)
                                .ceil();
                        i++)
                      Text(
